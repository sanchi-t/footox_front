...
const Homepage=()=>{
  ...
  useEffect(() => {
    ...
    <main className="ps-main">
      <div className="ps-banner">
        <div className="rev_slider fullscreenbanner" id="home-banner">
          <ul className="ps-banner">
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=725&q=80" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina/>
            ...
            <div className="masonry-wrapper" data-col-md="3" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
              <div className="ps-masonry">
                ...
                <div className="grid-item">
                  <div className="grid-item__content-wrapper"><a className="ps-offer" href="product-detail.html"><img src="images/offer/home-2-1.jpg" alt=""/></a></div>
                </div>
                <div className="grid-item">
                  <div className="grid-item__content-wrapper"><a className="ps-offer" href="product-detail.html"><img src="images/offer/home-2-2.jpg" alt=""/></a></div>
                </div>
                <div className="grid-item high">
                  <div className="grid-item__content-wrapper"><a className="ps-offer" href="product-detail.html"><img src="images/offer/home-2-5.jpg" alt=""/></a></div>
                </div>
                <div className="grid-item">
                  <div className="grid-item__content-wrapper"><a className="ps-offer" href="product-detail.html"><img src="images/offer/home-2-3.jpg" alt=""/></a></div>
                </div>
                <div className="grid-item">
                  <div className="grid-item__content-wrapper"><a className="ps-offer" href="product-detail.html"><img src="images/offer/home-2-4.jpg" alt=""/></a></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="ps-section__content pb-50">
            <div className="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
              <div className="ps-masonry">
                <div className="grid-sizer"></div>
                {products.map((item) => (
                <div className="grid-item kids" style={{float:'left'}} key={item._id}>
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail">
                        <div className="ps-badge"><span>New</span></div>
                        <div className="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src={item.images[0]} alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src={item.images[0]} alt=""/><img src={item.images[1]} alt=""/><img src={item.images[2]} alt=""/><img src={item.images[3]} alt=""/></div>
                ...
                {/* <div className="grid-item nike">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/2.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
                          <select className="ps-rating ps-shoe__rating">
                            <option value="1">1</option>
                            <option value="1">2</option>
                            <option value="1">3</option>
                ...
                <div className="grid-item adidas">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/3.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
                ...
                <div className="grid-item kids">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail">
                        <div className="ps-badge ps-badge--sale"><span>-35%</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/4.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
                ...
                <div className="grid-item men">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/5.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
                ...
                <div className="grid-item women">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/6.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
                ...
                <div className="grid-item kids">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/7.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
                ...
                <div className="grid-item kids">
                  <div className="grid-item__content-wrapper">
                    <div className="ps-shoe mb-30">
                      <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"></i></a><img src="images/clothes/8.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div className="ps-shoe__content">
                        <div className="ps-shoe__variants">
                          <div className="ps-shoe__variant normal"><img src="images/clothes/1.jpg" alt=""/><img src="images/clothes/2.jpg" alt=""/><img src="images/clothes/3.jpg" alt=""/><img src="images/clothes/4.jpg" alt=""/></div>
      ...
      <div className="ps-home-testimonial bg--parallax pb-80" data-background="https://img.freepik.com/free-psd/winter-sale-banner-design-template_23-2149123167.jpg?w=1380&t=st=1669321937~exp=1669322537~hmac=54b79e5c2deafdb96c11525a59196181d4cfa7d5d579acb4ca62877a7c6fa5c8">
