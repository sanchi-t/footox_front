              ...
              <div className="ps-section__content pb-50">
                <div className="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
                  ...
                  {products.map((item) => {
                      ...
                      return(
                        <div className="grid-item men" key={item.id} style={{float: 'left',display:'block',marginBottom:'80px' }}>
                        <div className="grid-item__content-wrapper" key={item.id} style={{minHeight: "300px",position: 'relative'}}>
                          <div className="ps-shoe mb-30" key={item.id}>
                            <div className="ps-shoe__thumbnail" key={item.id}>
                              ...
                              <a className="ps-shoe__favorite" href="#" key={item.id}><i className="ps-icon-heart" key={item.id}></i></a><img style={{height:'420px'}} key={item.id} src={item.image?.[0][0]} alt="" /><a className="ps-shoe__overlay" onClick={() => handleDes(item.productId)}></a>
                            </div>
                                ...
                                <div className="ps-shoe__variant normal owl-carousel owl-theme owl-loaded" key={item.id}>
                                  <div className='owl-stage-outer' key={item.id}>
                                    <OwlCarousel items={4} autoplay={true} dots={false} nav={false} key={item.id}>
                                      <img style = {{height : '55px',width :"55px" }} key={item.id} src={item.image?.[0][0]} alt="" /><img style = {{height : '55px',width :"55px" }} key={item.id} src={item.image?.[0][1]} alt="" /><img style = {{height : '55px',width :"55px" }} key={item.id} src={item.image?.[0][2]} alt="" /><img style = {{height : '55px',width :"55px" }} key={item.id} src={item.image?.[0][3]} alt="" />
                                    </OwlCarousel></div></div>
                    ...
                    {products.map((item) => {
                      ...
                      return(
                        <div className="grid-item women" key={item.id} style={{float: 'left',display:'block',marginBottom:'80px' }}>
                        <div className="grid-item__content-wrapper" key={item.id} style={{minHeight: "300px",position: 'relative'}}>
                          <div className="ps-shoe mb-30" key={item.id}>
                            <div className="ps-shoe__thumbnail" key={item.id}>
                              {/* <div className="ps-badge"><span>New</span></div> */}
                              ...
                              <a className="ps-shoe__favorite" key={item.id} href="#"><i key={item.id} className="ps-icon-heart"></i></a><img style={{height:'420px'}} key={item.id} src={item.image?.[0][0]} alt="" /><a key={item.id} className="ps-shoe__overlay" onClick={() => handleDes(item.productId)}></a>
                            </div>
