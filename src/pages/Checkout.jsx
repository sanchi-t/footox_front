...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${BackendServer}address`, { params: userData }).then((response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(JSON.stringify(form), "orders");
    const san=JSON.stringify(form);
    sessionStorage.setItem("order", san);
      ...
      <body className="ps-loading">
              ...
              <div className="row">
                  ...
                  <div className="ps-checkout__billing">
                    ...
                    <div className="form-group form-group--inline">
                      ...
                      <input
                        ...
                        type="text"
                        defaultValue={JSON.parse(sessionStorage.getItem("order"))?.name_reciever || ""}
                        name="name"
                      />
                    </div>
                    <div className="form-group form-group--inline">
                      ...
                      <input
                        className="form-control"
                        type="email"
                        defaultValue={JSON.parse(sessionStorage.getItem("order"))?.email_reciever || ""}
                        name="email"
                      />
                    </div>
                    <div className="form-group form-group--inline">
                      ...
                      <input
                        className="form-control"
                        type="text"
                        defaultValue={JSON.parse(sessionStorage.getItem("order"))?.mobile_reciever || ""}
                        name="mobile"
                      />
                    </div>
                    <div className="form-group form-group--inline">
                      ...
                      <input
                        ...
                        value={JSON.parse(sessionStorage.getItem("order"))?.address.place || currentAddress}
                      />
                    </div>
                    <div className="form-group">
                      <div className="ps-checkbox" style={{ width: "20rem", display: "inline" }}>
                        ...
                        <label for="cb01" name="saveAddress">
                          Save this address?
                        </label>
                      </div>

                      <label
                        style={{ paddingLeft: "5rem", cursor: "pointer", color: "#737373", fontSize: "1.4rem" }}
                        onClick={handleShow}
                      >
                        <a>Use other address?</a>
                      </label>
                    </div>
                ...
                <div id="col-xs-12-id2" className="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        ...
                        <tbody>
                          ...
                          {coupon !== 0 ? (
                            <tr>
                              ...
                              <td style={{ color: "green" }}>-₹{coupon}</td>
                            </tr>
                          ) : (
                            <></>
                          )}
                    ...
                    <footer>
                      ...
                      <div className="form-group paypal">
                        ...
                        <button className="ps-btn ps-btn--fullwidth">
                          Place Order<i className="ps-icon-next"></i>
                        </button>
                      </div>
                    </footer>
                  </div>
                  <div className="ps-shipping">
                    <h3>FREE SHIPPING</h3>
                    <p>
                      YOUR ORDER QUALIFIES FOR FREE SHIPPING.<br></br> <a href="#"> Singup </a> for free shipping on
        ...
        >
          ...
          >
                ...
                return (
                  <div className="radio" style={{ backgroundColor: "#E4E4E4" }} onChange={handleModal}>
                    <label className="labeladdress">
                      <input name="radioButton" type="radio" id={index + 1} value={item} />
                      {item}
                    </label>
                  </div>
                );
            ...
            <Modal.Footer>
              <Button
                style={{ padding: "0.6rem 1.2rem", marginBottom: "0", fontSize: "1.8rem", fontWeight: "400" }}
                variant="secondary"
                onClick={handleClose}
              >
                Close
