          ...
          <div class="row">
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              ...
              <div class="ps-product__thumbnail--mobile">
                ...
                <OwlCarousel items={3} autoplay={true} dots={false} nav={false}>
                  <img src="images/shoe-detail/1.jpg" alt=""/><img src="images/shoe-detail/2.jpg" alt=""/><img src="images/shoe-detail/3.jpg" alt=""/>
                  </OwlCarousel>
</div>
              </div>
