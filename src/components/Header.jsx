...
import logousa from '../images/flag/usa.svg';
import logosinga from '../images/flag/singapore.svg';
import logojapan from '../images/flag/japan.svg';
import logo from '../images/logo.png';
import cartpreview from "../images/cart-preview/1.jpg";
import cartpreview2 from "../images/cart-preview/2.jpg";
import cartpreview3 from "../images/cart-preview/3.jpg";
                  ...
                  <div className="header__actions"><a href="#">Login &amp; Regiser</a>
                    <div className="btn-group ps-dropdown"><a className="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i className="fa fa-angle-down" /></a>
                      <ul className="dropdown-menu">
                        <li><a href="#"><img src={logousa} alt="" /> USD</a></li>
                        <li><a href="#"><img src={logosinga} alt="" /> SGD</a></li>
                        <li><a href="#"><img src={logojapan}alt="" /> JPN</a></li>
                      </ul>
                    </div>
          ...
          <nav className="navigation">
            <div className="container-fluid">
              <div className="navigation__column left">
                <div className="header__logo"><a className="ps-logo" href="index.html"><img src={logo} alt="" /></a></div>
              </div>
                  ...
                  <div className="ps-cart__listing">
                    <div className="ps-cart__content">
                      <div className="ps-cart-item"><a className="ps-cart-item__close" href="#" />
                        <div className="ps-cart-item__thumbnail"><a href="product-detail.html" /><img src={cartpreview} alt="" /></div>
                        <div className="ps-cart-item__content"><a className="ps-cart-item__title" href="product-detail.html">Amazin’ Glazin’</a>
                          <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                        </div>
                      </div>
                      <div className="ps-cart-item"><a className="ps-cart-item__close" href="#" />
                        <div className="ps-cart-item__thumbnail"><a href="product-detail.html" /><img src={cartpreview2} alt="" /></div>
                        <div className="ps-cart-item__content"><a className="ps-cart-item__title" href="product-detail.html">The Crusty Croissant</a>
                          <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                        </div>
                      </div>
                      <div className="ps-cart-item"><a className="ps-cart-item__close" href="#" />
                        <div className="ps-cart-item__thumbnail"><a href="product-detail.html" /><img src={cartpreview3} alt="" /></div>
